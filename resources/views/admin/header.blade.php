    ...
    <div class="container-scroller">
      ...
      <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href=""><img src="{{asset('assets/')}}/admin/assets/images/logo-mini.svg" alt="logo"></a>
          </div>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="https://pbs.twimg.com/profile_images/1433135580032999431/JCg2HDcq_400x400.jpg" alt="">
