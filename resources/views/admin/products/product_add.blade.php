          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              ...
              <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data"  >
                  ...
                  <input type="number" name="price" class="form-control" required="" placeholder="Ürün fiyatını giriniz" >
                  </div>
                  <div class="form-group">
                  <label for="" >İndirimli Fiyat</label>
                  <input type="number" name="discount_price" class="form-control"  placeholder="Ürün fiyatını giriniz" >
                  </div>
                  <div class="form-group">
                  <label >Miktar</label>
                  <input type="number" name="quantity" class="form-control" required="" placeholder="Ürün miktarı giriniz" >
                  </div>
