    ...
    <div class="container">
                    ...
                    <div class="card-header">
                        <picture class="position-relative overflow-hidden d-block bg-light">
                            ...
                            <!--<picture class="position-absolute z-index-20 start-0 top-0 hover-show bg-light">
                                <img class="w-100 img-fluid" title="" src="/frontend/assets/images/products/product-1b.jpg" alt="">
                            </picture> -->
                ...
                <div class="rating position-relative d-table">
                    ...
                    <div class="stars">
                        ...
                        <a class="mb-0 mx-2 mx-md-4 fs-p link-cover text-decoration-none d-block text-center"
                            href="{{route('home.detail',$product->id)}}">{{$product->title}}</a>
                          @if($product->discount_price!=null)
                            <div class="d-flex justify-content-center align-items-center mt-2">
                            <p class="mb-0 me-2 text-danger fw-bolder">$<span>{{$product->discount_price}}</span></p>
        ...
        @endforeach
            <div class="swiper-slide d-flex h-auto justify-content-center align-items-center">
              <a href="{{route('home.show')}}" class="d-flex text-decoration-none flex-column justify-content-center align-items-center">
