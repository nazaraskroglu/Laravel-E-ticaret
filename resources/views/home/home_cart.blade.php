            ...
            <div>
                ...
                <!-- Cart Product-->
                    <div class="row mx-0 pb-4 mb-4 border-bottom">
                        ...
                        <div class="ps-sm-3">
                            <a href="" class="text-dark mt-1"></a>
                        </div>
                        <div class="col-9">
                            <div>
                                <h6 class="justify-content-between d-flex align-items-start mb-2">
                                    <a href="" onclick="return confirm('Silmek istediğinizden emin misiniz?')" ><i class="ri-close-line"></i></a>
                                </h6>
                                <small class="d-block text-muted fw-bolder">Size: Medium</small>
                                <small class="d-block text-muted fw-bolder"></small>
                            </div>
                            <p class="fw-bolder text-end m-0"></p>
                        </div>
                    </div>
            </div>
